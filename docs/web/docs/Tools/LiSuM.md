...
Before compiling and running LiSuM it is recommended to have the following softare on your computer:
...
Execute the Maven command install (*mvn install*) in the Traas, lisum-core and lisum-gui folders (in that order).
